  ...
  class SessionsController < BaseController
    ...
    def create
      ...
      if user && user.authenticate(params[:password])
        ...
        redirect_to main_app.blogo_admin_url, notice: I18n.translate('blogo.admin.logged_in')
      else
    ...
    def destroy
      ...
      redirect_to main_app.blogo_admin_url, notice: I18n.translate('blogo.admin.logged_out')
    end
  end
end
